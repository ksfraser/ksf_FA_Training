 ...
 * 
 * @package KsfFA_ksf_FA_Training
 * @version 2.4.3
 */

define('SS_ksf_FA_Training', 140 << 8);
...
class hooks_ksf_FA_Training extends hooks {
    ...
    function install_tabs($app) {
        ...
        // return new ksf_FA_Training_app();
    }
    ...
    function install_access() {
        ...
        $security_areas['SA_ksf_FA_TrainingMANAGE'] = array(
            SS_ksf_FA_Training | 2, 
            _("Manage ")
        );
